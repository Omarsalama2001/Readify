...
import 'package:fruit_e_commerce/test_screens/SignUpAuthor.dart';
import 'package:fruit_e_commerce/test_screens/SignUpUser.dart';
import 'package:fruit_e_commerce/test_screens/congratulation.dart';
                ...
                children: [
                  ...
                  TextButton(
                    onPressed: () {
                      Navigator.push(
                        context,
                        MaterialPageRoute(builder: (context) => signup_author()),
                      );
                    },
